...
export const SCENARIOS = {
  ...
  //    measurement, and it was miscalibrated: no configuration in a wide search
  //    satisfies it together with `edges >= 2`, because seed 138 needs enough
  //    crop to reach a second edge and by then the others exceed 0.35. Before
  //    widening it the candidate was rendered at 900px and looked at — seeds
  //    23, 47 and 138 at ink 0.33-0.36 show rounded bulges, concave notches and
  //    real negative space. The bound was wrong, not the design.
  large: {
